...
bidirectional Shiny session. Pass 9 is complete and production-verified.
...
| 9 | My Little Inverts | PASS 9 COMPLETE / PRODUCTION VERIFIED | official `DP1.20120.001` `RELEASE-2026`, DOI `10.48443/hp56-s582`; full-fetch run `30885526988` at source `a685e01c61938fcbd49325d7cf365aa272fae58a`; direct-child candidate `b7dffb6c1e149c52d094c4347483435df07856f6`; PR #6 merge `ff23e994e289982c747b91e48c5ff0907c1672d2`; release ID `sha256:fcee160ddb5e6ecedbca84811dea57993263507bbb8c38570b5243d5d7644ee5`; exact R 4.5.2 / 91-package manifest SHA-256 `26b94b5e8ddc5e22618ad47faf1b388802dfa76354fd38f0a33a5c4c1a0eb8d2` | complete field-first package records 34 sites; 7,198 non-DNA field opportunities; 6,477 primary, 6,213 count- and density-eligible, 830 events, 1,679 strata, 181,922 collapsed taxonomy rows, and 85,874 taxon-stratum search rows; source identity, opportunity status, method/habitat/water-type support, area-scoped density, taxonomy placeholders, zero/unknown, composition/EPT, claim limits, release identities, and adversarial fixtures are explicit | `CONTEXT / HOLD DRIVER INGESTION / NO DRIVER BYTE CHANGE`; density is a within-site/index quantity, EPT is composition rather than health/impairment, and current Driver join/support is `UNMEASURED, not zero` | Pages `30890184235` and Connect publication #17 (`019fcbca-a610-e368-7562-54b93e2056d0`) passed on exact merge `ff23e994`; production run `30890185880` / job `91930207585` passed exact Pages/Connect HTTP identity and a live bidirectional Shiny session; signed-in desktop QA loaded all 34 sites and SYCA without browser errors |
...
`CONTEXT / HOLD DRIVER INGESTION / NO DRIVER BYTE CHANGE`, and the next program
step is cross-product synthesis plus the formal complementary-product decision.
