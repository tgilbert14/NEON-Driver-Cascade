        ...
        tags$details(class = "lab-exp",
          ...
          div(class = "lab-exp-body",
            p(class = "le-intro", bs_icon("info-circle"),
              HTML(" Re-examine a <b>stated prior</b> by sliding the lag and toggling annual vs seasonal climate. Watch how easily a better-looking r appears when you search, and why that p is not a real one. The gold diamond is the prior lag, fixed before looking; it is the only honest reading here.")),
            ...
            p(class = "le-persistent-caveat", bs_icon("exclamation-triangle"),
              HTML(" You just looked at up to K lag-by-season combinations. With about 6 years, the best-looking one reaches p around 0.05 roughly 1 in 3 by chance. A p you found by sliding is not a p=.03 result. The honest tests are the prior lag (gold) and the cross-site pooling on Across NEON.")))),
