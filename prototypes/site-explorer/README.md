...
southern-Appalachian canopy), Soaproot Saddle (an open `~42%`-forested Sierra foothill woodland),
Smithsonian and Harvard (eastern deciduous), and Guánica (`~16 m` subtropical dry forest).
